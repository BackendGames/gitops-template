...
variable "ssh_max_sessions" {
  description = "The maximum number of open sessions permitted per connection."
  type        = number
  default     = 10
}

variable "ssh_max_startups" {
  description = "The maximum number of concurrent unauthenticated connections to the SSH daemon."
  type        = number
  default     = 10
}

variable "ssh_max_sessions_per_connection" {
  description = "The maximum number of open sessions permitted per connection."
  type        = number
  default     = 10
}

variable "ssh_max_auth_tries_per_connection" {
  description = "The maximum number of authentication attempts permitted per connection."
  type        = number
  default     = 2
}
